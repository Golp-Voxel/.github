...
| [Tango-Newport_AG_UC8](https://github.com/Golp-Voxel/Tango-Newport_AG_UC8) | Newport AG-UC8 piezo controller | qcodes_contrib_drivers | 4 channels, step amplitude control, position measurement |
...
| Repository | Instrument | Library | Notes |
|---|---|---|---|
| [Tango-Arduino_Shutter](https://github.com/Golp-Voxel/Tango-Arduino_Shutter) | Thorlabs shutter via Arduino | pyserial + ArduinoJson | JSON serial protocol, open/close cycles; PlatformIO firmware included |
...
|---|---|---|
| [Tango-Thorlabs_DMP40](https://github.com/Golp-Voxel/Tango-Thorlabs_DMP40) | Thorlabs DMP40 deformable mirror | ctypes prototype; Tango wrapper in progress |
...
All device servers follow the same structure:
